...
public class IntentReaderActivityTest extends ActivityInstrumentationTestCase2 {
    ...
    public void testDisplayText() {
        ...
        assertEquals("The text should be displayed.", "message 2", ira.getText());
    }
    ...
    public void testReverseText() {
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira = (IntentReaderActivity) getActivity();
        assertEquals("The text should be displayed in reverse.", "4 egassem",
                ira.getText());
    }
    ...
    public void testDefaultText() {
        ...
        setActivityIntent(intent);
        IntentReaderActivity ira = (IntentReaderActivity) getActivity();
        assertEquals("The default text should be displayed.", "default text",
                ira.getText());
    }
